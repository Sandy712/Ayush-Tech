...
const NewsComponent = () => {
    ...
    const fetchNews = async () => {
        try {
            const response = await axios.get('https://cors-anywhere.herokuapp.com/https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=28f6e8836bb34530b0c668a5a6a1d840');
